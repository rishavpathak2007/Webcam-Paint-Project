...
while True :
    ...
    # append the next deque when no contours are found 
    else: 
    ...
    # drawing lines for all the colors 
...
camera.release() # to stop the camera
cv2.destroyAllWindows() # to destroy / close all the open windows
